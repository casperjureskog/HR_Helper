                ...
                <b-col cols="12" md="auto" class="pt-3 text-right" :class="visible? 'bg-black' : ''">
                    <b-input-group class="mt-2">
                        ...
                        <b-input-group-append>
                            <b-button @click="search = null, $emit('search', search)" class="text-white"
                                variant="secondary">Cansel</b-button>
                ...
                <b-form>
                    <b-row>
                        ...
                        <b-col cols="6" class="py-2">
                            <b-button @click="onSubmit(newUser)" :disabled="newUser.email === null"
